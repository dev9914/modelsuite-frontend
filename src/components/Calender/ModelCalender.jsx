...
const ModelCalender = () => {
  ...
  console.log(userId, user.user.agencyId)
  ...
  const fetchEvents = async () => {
    try {
      const res = await fetch(`${baseUrl}/calendar/agency/${user.user.agencyId}/model/${userId}`, {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold">Model Calendar</h1>
          </div>
